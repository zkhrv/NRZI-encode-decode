...
def nrzi_signal(signal_levels, bits): #
    ...
    plt.suptitle(bits) # указываем заголовок всего графика. В заголовок, для удобства, я решил вписать биты строки 
    plt.show() 
...
def nrzi_encode_decode(): # метод для кодирования/декодирования
    ...
    print("Строка в виде битов: ", bits)
    ...
    nrzi_signal(bits, signal_levels) # график кодирования
