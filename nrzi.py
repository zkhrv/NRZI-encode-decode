...
def nrzi_signal(bits, signal_levels): #
    x = [0]  # начинаем отрисовку с нулевой точки
    y = [0 if signal_levels[0] == '0' else 1]  # начинаем отрисовку с нулевой точки
    ...
    plt.suptitle(signal_levels) # указываем заголовок всего графика. В заголовок, для удобства, я решил вписать биты строки 
    plt.show() 
...
def nrzi_encode_decode(): # метод для кодирования/декодирования
    ...
    nrzi_signal(signal_levels, bits) # график кодирования
